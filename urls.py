...
url_patterns = [
    ...
    (r'/a/tim/matrix/ticket/order/(?P<_id>[^\/]+)/?',
     a.tim.MatrixTicketOrderHandler),
    (r'/a/tim/matrix/ticket/type/(?P<_id>[^\/]+)/?',
     a.tim.MatrixTicketTypeHandler),
    ...
    (r'/a/content/(?P<_id>[^\/]+)/image/(?P<type>[^\/]+)/?',
     a.content.ContentImageUploadHandler),
    (r'/a/content/(?P<_id>[^\/]+)/active/user/?',
     a.content.ContentActiveUserHandler),
    (r'/a/content/(?P<_id>[^\/]+)/group/?', a.group.GroupHandler),
    (r'/a/content/(?P<content_oid>[^\/]+)/group/(?P<group_oid>[^\/]+)/?',
     a.group.GroupHandler),
    (r'/a/content/(?P<_id>[^\/]+)/groups/?', a.group.GroupListHandler),
    (r'/a/content/(?P<content_oid>[^\/]+)/group/(?P<group_oid>[^\/]+)/sms/send/?',
     a.group.GroupSmsSendHandler),
    (r'/a/content/(?P<content_oid>[^\/]+)/group/(?P<group_oid>[^\/]+)/ticket/?',
     a.group.GroupTicketHandler),
    (r'/a/content/(?P<content_oid>[^\/]+)/group/(?P<group_oid>[^\/]+)/tickets/?',
     a.group.GroupTicketListHandler),
    (r'/a/content/(?P<content_oid>[^\/]+)/group/(?P<group_oid>[^\/]+)/ticket/(?P<ticket_oid>[^\/]+)/?',
     a.group.GroupTicketHandler),
    (r'/a/content/(?P<content_oid>[^\/]+)/group/(?P<group_oid>[^\/]+)/ticket/(?P<ticket_oid>[^\/]+)/reset/?',
     a.group.GroupTicketResetHandler),
    (r'/a/content/(?P<content_oid>[^\/]+)/group/(?P<group_oid>[^\/]+)/ticket/(?P<ticket_oid>[^\/]+)/sms/send/?',
     a.group.GroupTicketSmsSendHandler),
    (r'/a/content/(?P<content_oid>[^\/]+)/group/ticket/search?',
     a.group.SearchGroupTicketHandler),
    ...
    (r'/a/ticket/order/(?P<_id>[^\/]+)/send/?',
     a.ticket.TicketOrderSendHandler),
    (r'/a/ticket/order/(?P<_id>[^\/]+)/serial_number_list/?',
     a.ticket.TicketOrderSerialNumberList),
    (r'/a/tickets/?', a.ticket.TicketListHandler),
    (r'/a/ticket/(?P<_id>[^\/]+)/?', a.ticket.TicketHandler),
    (r'/a/ticket/(?P<_id>[^\/]+)/register/user/?',
     a.ticket.TicketRegisterUserHandler),
    ...
    (r'/w/user/(?P<_id>[^\/]+)/auth/password?',
     w.user.UserAuthPasswordHandler),
    ...
    (r'/w/ticket/order/(?P<_id>[^\/]+)/tickets/unused?',
     w.ticket.TicketUnusedListHandler),
    (r'/w/ticket/order/(?P<_id>[^\/]+)/tickets/used?',
     w.ticket.TicketUsedListHandler),
    (r'/w/ticket/(?P<_id>[^\/]+)/register/?', w.ticket.TicketRegisterHandler),
    (r'/w/ticket/(?P<_id>[^\/]+)/register/cancel/?',
     w.ticket.TicketRegisterCancelHandler),
    ...
    (r'/w/ticket/(?P<_id>[^\/]+)/payment/status?',
     w.ticket.TicketPaymentStatusHandler),
    (r'/w/ticket/(?P<_id>[^\/]+)/payment/cancel?',
     w.ticket.TicketPaymentCancelHandler),
    (r'/w/ticket/(?P<_id>[^\/]+)/payment/complete?',
     w.ticket.TicketPaymentCompleteHandler),
    (r'/w/ticket/(?P<_id>[^\/]+)/enter?', w.ticket.TicketEnterUserHandler),
    (r'/w/ticket/types/me?', w.ticket.TicketTypeListMeHandler),
    (r'/w/ticket/type/(?P<_id>[^\/]+)/tickets?',
     w.ticket.TicketTypeTicketListMeHandler),
    (r'/w/qnas/?', w.qna.QnaListHandler),
    (r'/w/ticket/order/(?P<slug>[^\/]+)/?', w.ticket.TicketOrderSlugHandler),
    (r'/w/ticket/sn/(?P<serial_number>[^\/]+)/register?',
     w.ticket.TicketSerialNumberRegisterHandler),
    ...
    (r'/w/m/user/(?P<_id>[^\/]+)/new/password?',
     wm.user.UserNewPasswordHandler),
    (r'/w/m/user/(?P<_id>[^\/]+)/auth/password?',
     wm.user.UserAuthPasswordHandler),
    ...
    (r'/w/m/content/(?P<_id>[^\/]+)/ticket/orders?',
     wm.ticket.TicketOrderListHandler),
