...
url_patterns = [
    ...
    (r'/a/rfid/umfkorea/sync?', a.rfid.RfidUmfKoreaSyncHandler),
    ...
    (r'/a/v2/seller/stats/?', av2.seller.SellerStatsListHandler),
    ...
    (r'/w/ticket/log/(?P<_id>[^\/]+)/return/?', w.ticket.TicketLogReturnHandler),
    ...
    (r'/w/tickets/me/check/register/?', w.ticket.TicketMeCheckRegisterHandler),
    (r'/w/ticket/types/me/?', w.ticket.TicketTypeListMeHandler),
    (r'/w/ticket/type/(?P<_id>[^\/]+)/tickets/?', w.ticket.TicketTypeTicketListMeHandler),
    (r'/w/seller/me/?', w.seller.SellerMeHandler),
    (r'/w/seller/me/count/?', w.seller.SellerMeCountHandler),
